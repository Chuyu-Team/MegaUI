...
namespace YY
{
    namespace Base
    {
        namespace Utils
        {
            ...
            using ::_umul128;
#else
            inline constexpr uint64_t __fastcall _umul128(uint64_t _Multiplier, uint64_t _Multiplicand, uint64_t* _HighProduct) noexcept
            {
            ...
            using ::_udiv128;
#else
            inline constexpr uint64_t __fastcall _udiv128(uint64_t _HighDividend, uint64_t _LowDividend, uint64_t _Divisor, uint64_t* _Remainder) noexcept
            {
                uint32_t _Ret[4];
            ...
            inline constexpr uint64_t __fastcall UMulDiv64(
            ...
            /// <returns></returns>
            inline constexpr uint64_t __fastcall UMulDiv64Fast(
                _In_ uint64_t _uNumber,
                _In_ uint64_t _uNumerator,
                _In_ uint64_t _uDenominator) noexcept
            {
                ...
                {
                    _uNumerator = _uDenominator / _uNumerator;
                    auto _uRet = _uNumber / _uNumerator;
                    if ((_uNumber % _uNumerator) * 2 >= _uNumerator)
                    {
                        ++_uRet;
                    }
                    return _uRet;
            ...
            /// <param name="_uDenominator"></param>
            /// <returns></returns>
            inline constexpr int64_t __fastcall MulDiv64Fast(
                _In_ int64_t _uNumber,
                _In_ int64_t _uNumerator,
                _In_ int64_t _uDenominator) noexcept
            {
                if (_uNumerator < 0)
                {
                    _uNumerator *= -1;
