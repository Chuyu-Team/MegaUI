...
#define _MEGA_UI_ELEMENT_PROPERTY_TABLE(_APPLY) \
    ...
    _APPLY(Width,          PF_TriLevel | PF_Cascade,              PG_AffectsDesiredSize,                          &Value::CreateUnit<-1>,               nullptr,                             nullptr, nullptr, _MEGA_UI_PROP_BIND_UNIT(0, 0, YY_UFIELD_OFFSET(Element, CmpWidth)),            ValueType::Unit) \
    _APPLY(Height,         PF_TriLevel | PF_Cascade,              PG_AffectsDesiredSize,                          &Value::CreateUnit<-1>,               nullptr,                             nullptr, nullptr, _MEGA_UI_PROP_BIND_UNIT(0, 0, YY_UFIELD_OFFSET(Element, CmpHeight)),           ValueType::Unit) \
    _APPLY(X,              PF_TriLevel,                           0,                                              &Value::CreateUnit<0>,                nullptr,                             nullptr, nullptr, _MEGA_UI_PROP_BIND_UNIT(0, 0, YY_UFIELD_OFFSET(Element, CmpX)),                ValueType::Unit) \
    _APPLY(Y,              PF_TriLevel,                           0,                                              &Value::CreateUnit<0>,                nullptr,                             nullptr, nullptr, _MEGA_UI_PROP_BIND_UNIT(0, 0, YY_UFIELD_OFFSET(Element, CmpY)),                ValueType::Unit) \
    ...
    _APPLY(SizeInLayout,   PF_LocalOnly | PF_ReadOnly,            0,                                              &Value::CreateSizeZero,               nullptr,                             nullptr, nullptr, _MEGA_UI_PROP_BIND_SIZE(YY_UFIELD_OFFSET(Element, LocSizeInLayout), 0, 0),     ValueType::UnitSize) \
    _APPLY(DesiredSize,    PF_LocalOnly | PF_ReadOnly,            PG_AffectsLayout | PG_AffectsParentLayout,      &Value::CreateSizeZero,               nullptr,                             nullptr, nullptr, _MEGA_UI_PROP_BIND_SIZE(YY_UFIELD_OFFSET(Element, LocDesiredSize), 0, 0),      ValueType::UnitSize) \
    _APPLY(LastDesiredSizeConstraint, PF_LocalOnly | PF_ReadOnly, 0,                                              &Value::CreateSizeZero,               nullptr,                             nullptr, nullptr, _MEGA_UI_PROP_BIND_SIZE(YY_UFIELD_OFFSET(Element, LocLastDesiredSizeConstraint), 0, 0), ValueType::UnitSize) \
    ...
    _APPLY(MinSize,        PF_TriLevel | PF_Cascade,              PG_AffectsLayout | PG_AffectsParentLayout | PG_AffectsBounds | PG_AffectsDisplay, &Value::CreateSizeZero, nullptr,        nullptr, nullptr, _MEGA_UI_PROP_BIND_SIZE(0, YY_UFIELD_OFFSET(Element, SpecMinSize), YY_UFIELD_OFFSET(Element, CmpMinSize)), ValueType::UnitSize) \
    _APPLY(BorderThickness, PF_TriLevel | PF_Cascade,             PG_AffectsDesiredSize|PG_AffectsDisplay,        &Value::CreateRectZero,               nullptr,                             nullptr, nullptr, _MEGA_UI_PROP_BIND_RECT(0, YY_UFIELD_OFFSET(Element, SpecBorderThickness), YY_UFIELD_OFFSET(Element, CmpBorderThickness)), ValueType::UnitRect) \
    ...
    _APPLY(Padding,        PF_TriLevel | PF_Cascade,              PG_AffectsDisplay | PG_AffectsDesiredSize,      &Value::CreateRectZero,               nullptr,                             nullptr, nullptr, _MEGA_UI_PROP_BIND_RECT(0, YY_UFIELD_OFFSET(Element, SpecPadding), YY_UFIELD_OFFSET(Element, CmpPadding)), ValueType::UnitRect) \
    ...
    _APPLY(FocusThickness, PF_TriLevel | PF_Cascade,              PG_AffectsDesiredSize|PG_AffectsDisplay,        &Value::CreateRectZero,               nullptr,                             nullptr, nullptr, _MEGA_UI_PROP_BIND_RECT(0, YY_UFIELD_OFFSET(Element, SpecFocusThickness), YY_UFIELD_OFFSET(Element, CmpFocusThickness)), ValueType::UnitRect) \
    ...
    _APPLY(FontSize,       PF_TriLevel | PF_Cascade | PF_Inherit, PG_AffectsDesiredSize|PG_AffectsDisplay,        &Value::CreateUnit<20>,               nullptr,                             nullptr, nullptr, _MEGA_UI_PROP_BIND_UNIT(0, YY_UFIELD_OFFSET(Element, SpecFontSize), YY_UFIELD_OFFSET(Element, SpecFont.iSize)), ValueType::Unit) \
...
// clang-format on
        ...
        protected:
            ...
            UnitSize LocSizeInLayout;
            // 0x3C _sizeLocLastDSConst
            // Last desired size constraint local
            UnitSize LocLastDesiredSizeConstraint;
            // 0x44 DesiredSize
            // Desired size local
            UnitSize LocDesiredSize;
...
#define _MEGA_UI_ELEMENT_BITS_TABLE(_APPLY) \
    ...
    _APPLY(bSpecAccessible, 1)
        ...
        protected:
            ...
            Value __YYAPI GetGeneralCacheValue(ValueType _eType, PropertyIndicies _eIndicies, uint16_t _uOffsetToCache, uint8_t _uCacheBit);
