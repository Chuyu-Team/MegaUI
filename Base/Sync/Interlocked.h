...
namespace YY
{
    namespace Base
    {
        namespace Sync
        {
            ...
            inline Type __YYAPI Increment(Type* _pAddend)
            {
                return (Type)Increment(reinterpret_cast<volatile Type*>(_pAddend));
            }
            ...
            template<typename Type>
            inline Type __YYAPI Decrement(Type* _pAddend)
            {
                return (Type)Decrement(reinterpret_cast<volatile Type*>(_pAddend));
            }
            ...
            inline Type1 __YYAPI Add(Type1* _pAddend, Type2 _iAdd)
            {
                return (Type1)Add((volatile Type1*)_pAddend, (Type1)_iAdd);
            }

            template<typename Type1, typename Type2>
            inline Type1 __YYAPI Subtract(volatile Type1* _pAddend, Type2 _uAdd)
            {
                return (Type1)Add((volatile Type1*)_pAddend, (~(Type1)_uAdd) + 1);
            }
            ...
            {
                return BitSet((volatile uint32_t*)_pBase, _uOffset);
            }

            template<typename Type>
            inline bool __YYAPI BitSet(Type* _pBase, uint32_t _uOffset)
            {
                return BitSet((volatile Type*)_pBase, _uOffset);
            }
            ...
            {
                return BitReset((volatile uint32_t*)_pBase, _uOffset);
            }

            template<typename Type>
            inline bool __YYAPI BitReset(Type* _pBase, uint32_t _uOffset)
            {
                return BitReset((volatile Type*)_pBase, _uOffset);
            }
            ...
            {
                return (uint32_t)CompareExchange((volatile int32_t*)_pDestination, (int32_t)_iExchange, (int32_t)_iComparand);
            }
            ...
            {
                return (uint64_t)CompareExchange((volatile int64_t*)_pDestination, (uint64_t)_iExchange, (uint64_t)_iComparand);
            }
            
            template<typename _Type>
            inline _Type __YYAPI CompareExchange(_Type* _pDestination, _Type _iExchange, _Type _iComparand)
            {
                return (_Type)CompareExchange((volatile _Type*)_pDestination, (_Type)_iExchange, (_Type)_iComparand);
            }
            ...
            template<typename Type>
            inline Type* __YYAPI CompareExchangePoint(Type** _ppDestination, const Type* _pExchange, const Type* _pComparand)
            {
