...
#define YY_APPLY_ENUM_CALSS_BIT_OPERATOR(_ENUM)                      \
    inline constexpr_fun _ENUM& operator|=(_ENUM& _eLeft, _ENUM _eRight) \
    {                                                                \
    ...
    {                                                                \
        ...
        return _ENUM((_Type)_eLeft & (_Type)_eRight);                \
                                                                     ...
                                                                     \
    inline constexpr_fun _ENUM operator~(_ENUM _eLeft)                   \
    {                                                                \
        using _Type = std::underlying_type<_ENUM>::type;             \
        return _ENUM(~(_Type)_eLeft);                                \
    }                                                                \
                                                                     \
    inline constexpr_fun bool HasFlags(_ENUM _eLeft, _ENUM _eRight)      \
    {                                                                \
        using _Type = std::underlying_type<_ENUM>::type;             \
