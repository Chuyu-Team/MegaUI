...
namespace YY
{
    ...
    #undef _ENUM_TYPE
        ...
        Value Element::GetGeneralCacheValue(ValueType _eType, PropertyIndicies _eIndicies, uint16_t _uOffsetToCache, uint8_t _uCacheBit)
        {
        ...
        bool Element::SetGeneralCacheValue(ValueType _eType, PropertyIndicies _eIndicies, uint16_t _uOffsetToCache, uint8_t _uCacheBit, Value _NewValue)
        {
        ...
        Size Element::UpdateDesiredSize(Size _ConstraintSize)
        {
            ...
            const auto _bChangedConst = LocLastDesiredSizeConstraint.Value != _ConstraintSize;
            ...
            {
                sizeDesired = LocDesiredSize.Value;
            }
            return sizeDesired;
        }
